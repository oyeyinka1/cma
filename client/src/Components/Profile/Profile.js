      ...
      <div className="profile-col-2">
        ...
        <div className="profile-col-2-sub-2">
          <div className="contact-box">
            ...
            <div className="contact-box-item">08065473453</div>
            <div className="contact-box-action-grp">
              <div className="edit-btn"><Link to='/contact/edit'>Edit</Link>
              </div>
              <div className="delete-btn"><Link to='/contact/delete'>Delete</Link></div>
            </div>
          </div>
          <div className="contact-box">
            <div className="contact-box-item">John</div>
